  ...
  angular.module('survey')
    .controller('SurveyCtrl', ['$scope','$http', '$sce', function($scope, $http, $sce){
      ...
      $controller.felicidad = $sce.trustAs('html','<p>Este cuestionario fue creado para que la persona que lo realice pueda identificar '+
       'alguna de sus motivaciones o intereses profesionales enmarcados o clasificados en cinco campos determinados por las diferentes profesiones más conocidas.'+ 
...
'4-  Tecnológico <br>' +
'5-  Negocios<br> '+
'<p>Sabemos que podrían existir otros campos profesionales pero el objetivo actual es identificar la motivación inicial para una posterior búsqueda más profunda con mayores elementos personales que se deben tener para una elección profesional.</p>'+
' <br><b>METODOLOGIA</b> <br>'+
'<b>1- </b> <b>Lee y contesta con tu primer impulso</b> todas las frases que aparecen a continuación <br>'+
'<b>2-</b>  Deberás elegir la opción  que te gustan por lo tanto las que no me gustan ya no se tendrán en cuenta en la puntuación final <br>'+
'<b>3-</b>  Cuando contestes todo, podrás esperar inmediatamente un resultado de acuerdo a lo que has elegido (o puntuado). <br>'+
'<b>4-</b> Las conclusiones finales serán las que tuvieron mayor puntuación según la estructura  interna del cuestionario y lo que la persona ha puntuado. <br>'+
'<b>5-</b>  Podrás dejar tus datos si quisieras que te contactemos para un mejor análisis de tus intereses profesionales. <br>'
);
